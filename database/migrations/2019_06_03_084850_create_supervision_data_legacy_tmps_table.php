...
class CreateSupervisionDataLegacyTmpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('supervision_data_legacy_tmps', function (Blueprint $table) {
            $table->increments('id');
            $table->string('county');
    ...
    {
        Schema::dropIfExists('supervision_data_legacy_tmps');
    }
}
