	...
	export default {
		...
		data(){
			return {
				...
				categories : ["Facility Supervision 2019", "Facility Supervision 2018", "Baseline", "Facility Supervision 2020", "Facility Supervision 2021"],
				pneumonia: {
		...
		methods: {
			getSubCounties(){
				...
				.then(res => {
					...
					console.log(this.options.subcounties)
